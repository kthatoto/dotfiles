...
alias db='docker compose --profile core-backend build'
alias du='docker compose --profile core-backend up -d'
alias de='docker compose --profile core-backend exec'
alias dr='docker compose --profile core-backend run'
alias drs='docker compose --profile core-backend restart'
alias dl='docker compose --profile core-backend logs -f --tail=100'
alias dd='docker compose --profile core-backend down'
